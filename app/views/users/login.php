...
<head>
    ...
    <!-- Bootstrap 5.3.3 CSS (Latest stable matching 5.3.x) -->
    ...
    <style>
        ...
        .login-panel {
            ...
            /* Red background like the design */
            color: white;
        ...
        .decor-icon {
            ...
            /* Yellow background like the fries icon */
            border-radius: 15px;
            display: flex;
            align-items: center;
    ...
    <div class="container-fluid p-0">
        <div class="row g-0 login-container">
            ...
            <div class="col-md-5 login-panel d-flex align-items-center justify-content-center p-4 p-md-5">
                ...
                <!-- Decorative Icon (Shoe instead of fries) -->
                ...
                <div class="form-wrapper">
                    <form action="" method="post">
                        ...
                        <div class="mt-3">
                            Don't have an account? <a href="<?= BASE_URL ?>/users/register" class="register-link">Register</a>
                        </div>
                    </form>
                </div>
            </div>
